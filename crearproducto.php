        ...
        <div class="col-10 mt-2">
            <div class="row"> 
                ...
                <div class="col-9 asd qwe">
                    <h1 class="text-center mt-5">Ingresa los datos del nuevo producto</h1>
                    ...
                    <center>
                        <form  method="post">
                            ...
                            <input class="input" type="text"  name="descripcion" placeholder="Descripcion"> <br>
